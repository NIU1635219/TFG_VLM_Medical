...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "data/processed/scenario_results/scenario_D/run_*/results.jsonl"
        ),
    )
    parser.add_argument(
        "--limit",
...
def run(args: argparse.Namespace, reporter: Reporter | None = None) -> int:
    """Ejecuta el batch del Escenario D y guarda resultados incrementales en JSONL."""
    ...
    markdown_path = generate_single_detection_markdown_report(
        run_dir=run_dir,
        report_title="Scenario D Report",
        scenario_name="scenario_D",
        model_id=str(args.model),
